...
# Load the dataset
df = pd.read_csv('Results_of_A-star-algorithm_with_Manhattan_and-Euclidean_heuristics_with_tie_breaking_strategies_and_priority_queue_implementation.csv')
...
df.to_csv('Outlier_detection_results', index=False)
print("Updated dataset saved as 'Outlier_detection_results'")